...
def get_models():
    ...
    scaler = jb.load('/Users/Issamu Umeda/Documents/GitHub/Property Maintenance Blight Ticket Fines/model/scaler_blight_ticket.pk;.z')
    ...
    le_violation_code = jb.load('/Users/Issamu Umeda/Documents/GitHub/Property Maintenance Blight Ticket Fines/model/le_violation_code_blight_ticket.pk;.z')
